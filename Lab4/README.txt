...
Running the code requires python (version 2.7 was test) and the following libraries:

numpy (testes on 1.15.0)
matplotlib.pyplot (tested on matplotlib 2.2.2)
...
TASK 4.3 Here you will implement the wake-sleep algorithm to fine-tune all the parameters of the DBN. You would also have to implement new RBM methods for learning directed connections. You would have to work on the following functions:
